...
# Если размерность данных > 2, то используют иерархическую (мультииндекс). В один индекс включается несколькоо уровней
'''
index = [
    ('city_1', 2010),
    ('city_1', 2020),
...
print(i1)
'''
## - список кортежей, задающиих значение индекса в каждойточке
...
# 2. Из получившихся данны выбрать данные по
